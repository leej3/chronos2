...
def test_set_boiler_setpoint_success(device, mock_modbus_client):
    ...
    mock_modbus_client.return_value.write_register.return_value = MagicMock(isError=lambda: False)
...
def test_set_boiler_setpoint_failure(device, mock_modbus_client):
    ...
    # Mock write failure
    mock_modbus_client.return_value.write_register.return_value = MagicMock(isError=lambda: True)
